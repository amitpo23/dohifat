        ...
        {resultUrl && (
          ...
          >
            ...
            <div className="flex gap-2">
              <a href={resultUrl} download="photobooth.png" target="_blank" className="flex-1 py-2 bg-hoopoe text-white text-center font-bold rounded-xl text-sm">💾 שמירה</a>
              <button onClick={() => { setResultUrl(null); setSelectedEffect(null) }} className="flex-1 py-2 bg-gray-100 text-desert-brown text-center font-bold rounded-xl text-sm">🔄 אפקט אחר</button>
            </div>
