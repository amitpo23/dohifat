        ...
        {resultUrl && (
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => { setResultUrl(null); setSelectedBg(null); setSaved(false); setCustomPrompt('') }} className="flex-1 py-2 bg-gray-100 text-desert-brown text-center font-bold rounded-xl text-sm">🔄 רקע אחר</button>
            </div>
